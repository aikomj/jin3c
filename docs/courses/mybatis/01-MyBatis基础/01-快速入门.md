...
![202012252222518](./img/202012252222518.png)

笔者下载了 MyBatis 的核心压缩包（mybatis-x.x.x.zip）及其源码包（mybatis-x-mybatis-x.x.x.zip）。

![202012252222738](./img/202012252222738.png)

解压开 **mybatis-3.5.6.zip** 压缩包，目录结构如下：

![202012252222812](./img/202012252222812.png)
...
![202012252223067](./img/202012252223067.png)
...
![202012252223708](./img/202012252223708.png)
