...
![202101140900569](./img/202101140900569.png)

在弹出的对话框中，选择 `Plugins`，然后在 `Marketplace` 插件市场中输入 `lombok` 回车搜索，搜索到了点击`Install` 安装就可以了。

![202101140900570](./img/202101140900570.png)

安装成功后，直接点击 `Restart IDE` 重启 IDEA，插件就安装成功了。

![202101140900571](./img/202101140900571.png)
...
![202101140900572](./img/202101140900572.png)
...
![202101140900577](./img/202101140900577.png)

还有，如果你不想 `toString` 方法输出属性名，那么 `includeFieldNames=false` 适合你。

![202101140900579](./img/202101140900579.png)
...
![202101140900581](./img/202101140900581.png)
...
![202101140900583](./img/202101140900583.png)
...
![202101140900585](./img/202101140900585.png)
...
![202101140900587](./img/202101140900587.png)
...
![202101140900589](./img/202101140900589.png)
...
![202101140900591](./img/202101140900591.png)
...
![202101140900593](./img/202101140900593.png)
